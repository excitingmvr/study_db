CREATE TABLE IF NOT EXISTS `nct`.`infrCodeGroup` (
  ...
  `regSeq` BIGINT NULL,
  `regDeviceCd` INT NULL,
  `regDateTime` DATETIME NULL,
  `regDateTimeSvr` DATETIME NULL,
  `modIp` VARCHAR(100) NULL,
  `modSeq` BIGINT NULL,
  `modDeviceCd` INT NULL,
...
CREATE TABLE IF NOT EXISTS `nct`.`infrMember` (
  ...
  `ifmmGenderCd` INT NULL,
  `ifmmDob` DATE NULL,
  `ifmmSavedCd` INT NULL COMMENT '회원정보저장기간',
  `ifmmMarriageCd` INT NULL,
...
CREATE TABLE IF NOT EXISTS `nct`.`infrMemberPhone` (
  ...
  `ifmpTypeCd` INT NULL,
  `ifmpDeviceCd` INT NULL,
  `ifmpTelecomCd` INT NULL,
